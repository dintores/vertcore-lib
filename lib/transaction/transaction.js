...
Transaction.prototype.fromBufferReader = function(reader) {
  ...
  if (hasWitnesses) {
    // TODO: @Cubey2019 attach witnesses to inputs
    for (i = 0; i < sizeTxIns; i++) {
      var witnessCount = reader.readVarintNum();
      for (var j = 0; j < witnessCount; j++) {
        var witnessSize = reader.readVarintNum();
        var witness = reader.read(witnessSize);
      }
    }
  }
 ...
 * ```
 * {
 *  address: 'VnURT9sJvasuMQ2zeXDDYJHFhgvJoMnf8G',
