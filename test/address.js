...
describe('Address', function() {
  ...
  var pubkeyhash = new Buffer('b0218c8fd144fb274e2ff08395f0537b78fe63ff', 'hex');
  var buf = Buffer.concat([new Buffer([0x47]), pubkeyhash]);
  var str = 'Vr482W7yjMfKqjht1agB9oz7Pbm5Taxhhr';
  ...
  // livenet valid
  var PKHLivenet = [
    'VnWjWCWtBXfVMEVaVLRJCvZTaWaXHJ1Sbb',
    'VqRSnfY6hC98pZe97FHtZC4N2WXMKLL1BB',
    'ViafDdTsejHymjhunceZ8cqjTdXfdEeDZi',
    'VuCtBtfSChfHN3HnF5JQ2hjz4tDApsHd5j',
    '    VuCtBtfSChfHN3HnF5JQ2hjz4tDApsHd5j   \t\n'
  ];
  ...
  //testnet valid
  var PKHTestnet = [
    'X7vDrrXm3xbaeqsi6AA1TBfqW4K92vnjHY',
    'X9H9C8DtYdbLcYMfoT6duGLacKJxXM9zVm',
    'X3TjqKxNpXpvdMYVf5CVPFZXKrnSUwZfAp',
    'X33fd7BCaLNBuP7MUgGfdhvo7edMX6VETA'
  ];
  ...
  describe('validation', function() {
    ...
    it('addresses with whitespace are validated correctly', function() {
      var ws = '  \r \t    \n Vg2sxR3t2dTMPHFmhHzNAg1HvDGvKbHxsg \t \n            \r';
      var error = Address.getValidationError(ws);
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('Vg2sxR3t2dTMPHFmhHzNAg1HvDGvKbHxsg');
    });
  });
  ...
  describe('encodings', function() {
    ...
    it('should make this address from a compressed pubkey', function() {
      ...
      address.toString().should.equal('Vig6zcsHwu7Xvfecpt3VzHoRKokbWu8fvm');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      ...
      a.toString().should.equal('VfJMhR8BiHcAjkrDhsvhJ9wpYWB7GewajG');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('VfJMhR8BiHcAjkrDhsvhJ9wpYWB7GewajG');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('VtJyihE3f62p5ezVWWLKiV8Hv6F1rCirmE');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('VtJyihE3f62p5ezVWWLKiV8Hv6F1rCirmE');
      });
      ...
      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'Vj3um86ZQWsH4oyPXw9jVGFXeNskWoupZJ';
      ...
      it('returns the same address if the script is a pay to script hash out', function() {
        var address = '3Pp1ic9zTGZ2Gn9t2K4XHn1kBqwahJWXi4';
  ...
  describe('#toBuffer', function() {
    ...
    it('b0218c8fd144fb274e2ff08395f0537b78fe63ff corresponds to hash Vr482W7yjMfKqjht1agB9oz7Pbm5Taxhhr', function() {
      var address = new Address(str);
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: Vr482W7yjMfKqjht1agB9oz7Pbm5Taxhhr, type: pubkeyhash, network: livenet>';
