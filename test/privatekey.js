...
describe('PrivateKey', function() {
  ...
  it('should create a private key from WIF string', function() {
    var a = new PrivateKey('5JEdn2uaFsgetmzkTuEpHDFe51KnUvGPxfQwfYBVMoCUKQdKGLy');
    should.exist(a);
    should.exist(a.bn);
  });

  it('should create a private key from WIF buffer', function() {
    var a = new PrivateKey(Base58Check.decode('5JEdn2uaFsgetmzkTuEpHDFe51KnUvGPxfQwfYBVMoCUKQdKGLy'));
    should.exist(a);
    should.exist(a.bn);
  });
  ...
  describe('instantiation', function() {
    ...
    it('should not be able to instantiate private key because of network mismatch', function() {
      expect(function() {
        return new PrivateKey('5JEdn2uaFsgetmzkTuEpHDFe51KnUvGPxfQwfYBVMoCUKQdKGLy', 'testnet');
      }).to.throw('Private key network mismatch');
    });

    it('should not be able to instantiate private key WIF is too long', function() {
      expect(function() {
        var buf = Base58Check.decode('5JEdn2uaFsgetmzkTuEpHDFe51KnUvGPxfQwfYBVMoCUKQdKGLy');
  ...
  describe('#toAddress', function() {
    it('should output this known livenet address correctly', function() {
      var privkey = PrivateKey.fromWIF('5JEdn2uaFsgetmzkTuEpHDFe51KnUvGPxfQwfYBVMoCUKQdKGLy');
      var address = privkey.toAddress();
      address.toString().should.equal('Vg2sxR3t2dTMPHFmhHzNAg1HvDGvKbHxsg');
    });

    it('should output this known testnet address correctly', function() {
      var privkey = PrivateKey.fromWIF('cPLFywrBf5wo8D35oAAQ3iUc3nP8HvFSkX4vE8aCLnLodsockQVV');
      var address = privkey.toAddress();
      address.toString().should.equal('X33fd7BCaLNBuP7MUgGfdhvo7edMX6VETA');
    });
  ...
  describe('#getValidationError', function(){
    ...
    it('should validate as true', function() {
      var a = PrivateKey.isValid('5JEdn2uaFsgetmzkTuEpHDFe51KnUvGPxfQwfYBVMoCUKQdKGLy');
      a.should.equal(true);
    });
  ...
  describe('#toPublicKey', function() {
    ...
    it('should convert this known PrivateKey to known PublicKey and preserve compressed=true', function() {
      var privwif = 'Ky5BKmR3nei2FXbtqjZygZ5ccgRukE6xLgYgH6dJAnudaFAVNGbF';
  ...
  it('creates an address as expected from WIF, livenet', function() {
    var privkey = new PrivateKey('5Jin8XDbEd8ej7jhVXFugvrB6C3zJLWQvtRa4BoJ9ndbem9rPUZ');
    privkey.publicKey.toAddress().toString().should.equal('VhFYNaULHGf5YycCKsBZLhLqntf1EDesqg');
  });

  it('creates an address as expected from WIF, testnet', function() {
    var privkey = new PrivateKey('cPLFywrBf5wo8D35oAAQ3iUc3nP8HvFSkX4vE8aCLnLodsockQVV');
    privkey.publicKey.toAddress().toString().should.equal('X33fd7BCaLNBuP7MUgGfdhvo7edMX6VETA');
  });
