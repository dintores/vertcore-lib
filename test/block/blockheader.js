...
var dataRawBlockBuffer = fs.readFileSync('test/data/block837002.dat');
var dataRawBlockBinary = fs.readFileSync('test/data/block837002.dat', 'binary');
var dataRawId = 'f2fa0db3347a3168043902eefd9ba57ccba74eee4d92719149a6d07be4f96fda';
var data = require('../data/block837002');
...
describe('BlockHeader', function() {
  ...
  describe('#fromRawBlock', function() {
    ...
    it('should instantiate from a raw block binary', function() {
      ...
      new BN(x.bits).toString('hex').should.equal('1b01dbba');
    });
  ...
  describe('#getDifficulty', function() {
    it('should get the correct difficulty for block 837002', function() {
      var x = BlockHeader.fromRawBlock(dataRawBlockBuffer);
      x.bits.should.equal(0x1b01dbba);
      x.getDifficulty().should.equal(35265.97277191);
    });
